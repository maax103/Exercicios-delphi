...
begin
  ...
  begin
    ...
    xAno[I] := StrToInt(inputbox('Informar ano de fabricação',
      'Ano (YYYY): ', ''));
    xPreco[I] := StrToFloatDef(inputbox('Informar o preço', 'Preço: ', ''), 0);
    ...
    if MessageDlg('Deseja informar outro veículo?', mtInformation,
  ...
  memResult.Lines.Add(Format('Total de carros até 2000: %d' ,[Length(xCarrosVelhos)]));
end;
